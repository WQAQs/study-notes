...
class TestCh01(unittest.TestCase):
    ...
    def test_article_functionality(self):
        ...
        article_id = str(post_article(conn, 'google', 'title A', 'http://www.google.com'))
        print("We posted a new article with id:", article_id)
        print()
        self.assertTrue(article_id)

        article_id1 = str(post_article(conn, 'baidu', 'title B', 'http://www.baidu.com'))
        print("We posted a new article with id:", article_id1)
        print()
        self.assertTrue(article_id1)
        ...
        # print("We added the article to a new group, other articles include:")
        # articles = get_group_articles(conn, 'new-group', 2)
        # pprint.pprint(articles)
        # print()
        # self.assertTrue(len(articles) >= 1)
